  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { 
            boxShadow: "0 0 20px hsl(43 90% 55% / 0.3)",
          },
          "50%": { 
            boxShadow: "0 0 40px hsl(43 90% 55% / 0.5)",
          },
        },
        "float": {
      ...
      backgroundImage: {
        ...
        "shimmer": "linear-gradient(90deg, transparent, hsl(43 90% 55% / 0.1), transparent)",
      },
    },
  },
