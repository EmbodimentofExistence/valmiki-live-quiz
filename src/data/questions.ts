...
const questionBank: Record<string, { question: string; answer: string }[]> = {
  ...
  history: [
    ...
    { question: "Who was known as the “Father of the Nation” in India?", answer: "Mahatma Gandhi" },
    ...
    { question: "Which ancient civilization built the pyramids?", answer: "Egyptian civilization" },
  ...
  geography: [
    ...
    { question: "Which was the first hydropower project of Nepal?", answer: "Pharping" },
    { question: "Which districts are known as the districts beyond the Himalaya (Himal parika jilla)?", answer: "Manang and Mustang" },
    { question: "In which district is the famous pilgrimage site Pathibhara Mandir situated?", answer: "Taplejung" },
    { question: "Which district of Nepal is known as ‘the district of suspension bridges’ (jholunge poolko jilla)?", answer: "Baglung" },
    { question: "On the map of the world, which country’s boundary is most similar to that of Nepal?", answer: "Portugal" },
    { question: "If the driest place of Nepal is Mustang, which is the wettest place of Nepal?", answer: "Pokhara (Lumle)" },
